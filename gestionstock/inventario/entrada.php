...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    if (
        ...
        try {
            ...
            $exito = "Entrada de inventario registrada correctamente.";
...
<head>
    ...
    <title>Entrada de inventario - GestionStock</title>
...
">
    ...
    ">
        ...
        <div class="panel">
            ...
            <p class="subtitulo"
               style="margin-bottom: 25px;">
                ...
                que deseas ingresar al inventario.
        ...
        <div class="panel">
            ...
            <h2>
                💡 ¿Qué ocurre al registrar una entrada?
            </h2>

            <p style="color: #6b7280;">

                La cantidad ingresada se suma automáticamente
                al stock actual del producto y se registra un
                movimiento de tipo <strong>ENTRADA</strong>
                en el historial del inventario.
